...
<br>Трудности в ДЗ:
<br>1. Трудноестей много. Первую часть пытался сделать через методы, интерфейсы, наследование и тд. Уверен что так и надо было делать. Не смог даже заполнить LinkedList через переменную size, когда прописывал аргумент size в круглых скобках IDEA выдает ошибку.Rогда прописываю метод и пытаюсь его вызвать у определенного класса, получается какая то ерунда. У;е окончательно запутался в java. 
